    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-green-50 to-green-100 font-sans">
        ...
        <header className="bg-green-600 p-6 shadow-md rounded-b-3xl text-white text-center">
          <h1 className="text-4xl font-bold tracking-wide">Sentence Construction</h1>
        </header>
        ...
        <section className="flex flex-col items-center justify-center text-center px-6 py-16">
          ...
          />
          <h2 className="text-3xl font-semibold text-green-700 mb-4">Welcome to the Challenge!</h2>
        ...
        <section className="flex flex-wrap justify-center gap-8 px-6 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 w-60 text-center">
            ...
            <p className="text-2xl text-green-600 font-bold">23</p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 w-60 text-center">
        ...
        <section className="flex justify-center gap-8 pb-16">
          <button className="px-6 py-3 bg-green-700 hover:bg-green-800 text-white rounded-full shadow-md transition"
            onClick={() => navigate('/')}>
            Back
          </button>
          <button className="px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-md transition"
